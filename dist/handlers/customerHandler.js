...
const createCustomer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!name && !email && !age) {
            Logger_1.Logger.error("name, email and age are required");
        ...
        return res.status(500).json({
            details: error.message,
            message: "customer can not be created, an error occured while creating customer",
        });
    }
});
...
const updateCustomer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!name && !age) {
            Logger_1.Logger.error("name or age are required");
